    ...
    <Container>
      <Row>
        <Col sm={12} className="mt-5">
          ...
          <div>
            <h2>Beranda</h2>
            <h3> Mata Kuliah Pemrograman Berbasis Framework adalah sebuah mata kuliah yang diharapkan dapat memberikan pengetahuan dan keterampilan pembuatan aplikasi web menggunakan framework ReactJS, firebase, dan backend Laravel. </h3>
          </div>
        </Col>
      </Row>
    </Container>
    ...
    <Container>
      <Row>
        <Col sm={12} className="mt-5">
          ...
          <div>
            <h2>Tentang</h2>
            <h3>NIM: 1841720157</h3>
            <h3>Nama: Andri Yoga Susila</h3>
          </div>
        </Col>
      </Row>
    </Container>
